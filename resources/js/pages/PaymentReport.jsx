  ...
  return <div className="page-shell page-fade-up">
    <div className="elevated-card border-beam-aurora" style={{ marginBottom: 16 }}><Title level={2}>{title}</Title><Paragraph>{isReceipt ? 'Money in: all customer and vendor receipts.' : 'Money out: all customer and vendor payments.'}</Paragraph>
      <Row gutter={[12, 12]} align="bottom">
        ...
        <Col xs={12} md={4}><Text strong>Counter Party</Text><Select allowClear placeholder="All" value={filters.counterparty_type} onChange={(value) => setFilters((current) => ({ ...current, counterparty_type: value, counterparty_id: undefined }))} options={[{ value: 'customer', label: 'Customers' }, { value: 'vendor', label: 'Vendors' }]} /></Col>

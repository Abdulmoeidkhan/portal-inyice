...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($driver === 'mysql') {
            DB::statement("ALTER TABLE orders MODIFY status ENUM('quote','order','confirm','cancel','invoice','void','refund','partial_refund','paid','partial_paid') NOT NULL DEFAULT 'quote'");
        }
    }
